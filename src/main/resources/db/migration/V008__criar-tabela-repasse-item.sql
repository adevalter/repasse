CREATE TABLE `repasse_item`(
  ...
  `data_procedimento` datetime NULL DEFAULT NULL,
  ...
  key `repasseitem_paciente_id` (`paciente_id`),
  ...
  CONSTRAINT `repasseitem_paciente_id` FOREIGN KEY (`paciente_id`) REFERENCES `pessoa` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
