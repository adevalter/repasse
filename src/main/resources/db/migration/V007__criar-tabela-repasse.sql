create table `repasse`(
  ...
  key `repasse_convenio_id` (`convenio_id`),
  ...
  CONSTRAINT `repasse_convenio_id` FOREIGN KEY (`convenio_id`)  REFERENCES `convenio` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
